...
# Pytorch is needed to run this code. Can be installed via the comamnd below:
...
def analyze_content_with_transformers(content):
...
if __name__ == "__main__":
    ...
    if "Error" in page_content:
        ...
        print("\nSummarizing article...\n")
        result = analyze_content_with_transformers(page_content)
        print("\nSummary:\n", result)
